...
<head>
  ...
  <title>Teatro Ictus 60 años</title>
...
<body data-spy="scroll"  data-target=".ajustar_menu">
	...
	<header>
	  <div class="top_menu">
		  <div class="container barra_menu">
			  <img src="assets/img/logo_ictus.png" width="120" height="120"/>
		  </div><!-- /.barra_menu -->
		  ...
		  <div class="ajustar_menu">
		      ...
		      <div class="nav-wrapper container">
		        ...
		        <ul class="right hide-on-med-and-down">
	          	...
	          	<li><a href="biblioteca.html" target="_self" class="active">Biblioteca</a></li>
	          	<li><a href="equipo.html" target="_self" class="">Equipo</a></li>
	          	<li><a href="contacto.html" target="_self" class="">Contacto</a></li>
	          	<li><a href="#" target="_self" class="">Transparencia</a></li>
	  ...
	  <div class="container">
				...
				<div class="row">
					<div class="col l12 s12">
						<div class="titulo_oscuro">
							Biblioteca <span> Audiovisual</span>
						</div><!-- ./titulo -->
					</div><!-- /.col -->
				</div><!-- ./row -->
			</div><!-- /.section -->
			...
			<div class="section">
              ...
              <div class="input-field">
                <input placeholder="Tu Búsqueda en Biblioteca" id="" type="text">
              </div>
			...
			<div class="section">
				<div class="row">
							<div class="col l4 m6 s12">
								<div class="menu_biblioteca">
										<h6>Audiovisual</h6><!-- limitar a 70 caracteres -->
										<a href="biblioteca_audiovisual.html" target="_self" class="btn_gris2 selected">Entrevistas "Sueños en la Memoria"</a>
										
										<br>
										
										<h6>Documentos</h6><!-- limitar a 70 caracteres -->
										<a href="#" target="_self" class="btn_gris2">Programas de Obras</a>
										<a href="#" target="_self" class="btn_gris2">Ictus Informa</a>
										<a href="#" target="_self" class="btn_gris2">Archivo</a>
										<a href="#" target="_self" class="btn_gris2">Libros y Artículos</a>
										
										<br>
										
										<h6>Academia</h6><!-- limitar a 70 caracteres -->
										<a href="#" target="_self" class="btn_gris2">Tesis de Grado</a>
										<a href="#" target="_self" class="btn_gris2">Memorias</a>
										
										<br>
										
										<h6>Repertorio</h6><!-- limitar a 70 caracteres -->
										<a href="#" target="_self" class="btn_gris2">Obras Estrenadas</a>
										<a href="#" target="_self" class="btn_gris2">Creación Colectiva</a>
								</div><!-- /.post_noticia -->
							</div><!-- /.col push-l4 s12-->
							
							<div class="col l8 m6 s12">
								<div class="titulo_oscuro">
									<span> Entrevistas "Sueños en la memoria"</span>
								</div><!-- ./titulo -->
									...
									<div class="row">
										<div class="col l4 m12">
											<div class="post_noticia">
												<img src="assets/img/biblioteca_01.jpg" class="responsive-img"/><!-- proporción 580x300 -->
												<div class="section">
													<h5>ESTO (NO) ES UN TESTAMENTO</h5><!-- limitar a 70 caracteres -->
													<p>Esto (no) es un testamento es un ejercicio de memoria, un momento de pausa en donde el reloj se pone entre paréntesis, una evaluación a escala humana del paso del tiempo, una pregunta por lo que se deja atrás y por lo que se viene.</p>
													<a href="#modal1" target="_self" class="btn_rojo">Más información</a>
												</div><!-- /.section -->
											</div><!-- /.post_noticia -->
										</div><!-- /.col -->
									  ...
									  <div id="modal1" class="modal">
										  <a href="" class="modal-close btn_cerrar"><i class="material-icons">close</i></a><br><br>
									    <div class="modal-content">
										    <div class="video-container">
									        <iframe width="560" height="315" src="https://www.youtube.com/embed/5ltmo2XRiQ0?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
									      </div>
									      <div class="section">
										      <h4>ESTO (NO) ES UN TESTAMENTO</h4>
  									      <p>Esto (no) es un testamento es un ejercicio de memoria, un momento de pausa en donde el reloj se pone entre paréntesis, una evaluación a escala humana del paso del tiempo, una pregunta por lo que se deja atrás y por lo que se viene.</p>
													<a href="" target="_self" class="btn_rojo">Botón Opcional</a>
									      </div><!-- /.section -->
									    </div>
									  </div>
										...
										<div class="col l4 m12">
											<div class="post_noticia">
												...
												<div class="section">
													<h5>ESTO (NO) ES UN TESTAMENTO</h5><!-- limitar a 70 caracteres -->
													<p>Esto (no) es un testamento es un ejercicio de memoria, un momento de pausa en donde el reloj se pone entre paréntesis, una evaluación a escala humana del paso del tiempo, una pregunta por lo que se deja atrás y por lo que se viene.</p>
													<a href="#" target="_self" class="btn_rojo">Más información</a>
												</div><!-- /.section -->
											</div><!-- /.post_noticia -->
										</div><!-- /.col -->
  ...
  <script src="assets/js/ajustar_menu.js"></script>
  ...
  <!-- Go to www.addthis.com/dashboard to customize your tools --> <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-595fd8ffdab95fd2"></script> 
